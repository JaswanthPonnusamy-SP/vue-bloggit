  ...
  <div style="width: 1200px;margin: auto;background: white">
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li>
          <svg @click="changeLocation('http://localhost:8080/Bloggit.html')" width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g id="Welcome" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
